...
- [ ] Create `services/ai-video-generator/` folder
...
- [ ] Save generated video to temporary folder
- [ ] Return file path or URL in response
- [ ] Add basic file cleanup logic
