          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
                Please review our terms of service below. Contact us if you have any questions.
              </p>
            </div>
            <Card className="bg-background/80 backdrop-blur-sm border-2 border-muted/30">
              <CardContent className="p-8 text-base leading-relaxed">
                <p className="mb-4">This is a placeholder Terms of Service page for OpenCut.</p>
                <p className="mb-4">Please contact us if you have any questions about our terms.</p>
