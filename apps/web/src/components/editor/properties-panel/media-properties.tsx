  ...
  return (
    <div className="space-y-4 p-5">
      ...
      <div className="flex flex-col gap-3">
        ...
        <PropertyItem 
          label="Duration:" 
          value={mediaItem.duration ? formatDuration(mediaItem.duration) : "N/A"} 
        />

        <PropertyItem 
          label="Resolution:" 
          value={mediaItem.width && mediaItem.height ? `${mediaItem.width} × ${mediaItem.height}` : "N/A"} 
        />
        ...
        {mediaItem.file && (
          <>
            ...
            <PropertyItem 
              label="Last modified:" 
              value={new Date(mediaItem.file.lastModified).toLocaleDateString()} 
            />
          </>
        )}
      </div>
      ...
      <div className="border-t pt-3">
        <h4 className="text-xs font-medium text-muted-foreground mb-3">Element Properties</h4>
        <div className="flex flex-col gap-3">
