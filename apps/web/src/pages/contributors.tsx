  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-background">
        <Head>
          <title>Contributors - OpenCut</title>
          <meta
            name="description"
            content="Meet the amazing people who contribute to OpenCut, the free and open-source video editor."
          />
        </Head>
        <Header />
    ...
    <div className="min-h-screen bg-background">
      <Head>
        ...
        <meta
          ...
          content="Meet the amazing people who contribute to OpenCut, the free and open-source video editor."
        />
        <meta property="og:title" content="Contributors - OpenCut" />
        <meta
